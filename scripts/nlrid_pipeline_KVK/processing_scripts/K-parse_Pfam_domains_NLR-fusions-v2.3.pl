...
while ($file=<PS>){                                                                                                
	...
	$outfile{$species}{'nlrsd'} = $outdir . "/" . $basefile . ".NLR-ID.txt";
...
open STATS1 , ">", $outdir . "/" . "nlrsd_domains-" . $today . ".stats.tsv";
...
open SUMMARYFILE, ">", $outdir . "/" . "nlrsd_summary_table" . $today . ".tsv"; 
...
open SUMMARYFILE2, ">", $outdir . "/" . "nlrsd_by_prevalence" . $today . ".tsv";
open DATAFILE1, ">", $outdir . "/" . "nlrsd_by_prevalence_family_wordcloud_input" . $today . ".txt";
